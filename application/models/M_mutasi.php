...
class M_mutasi extends CI_Model
{
    ...
    public function create_mutations($mutations) {
        ...
        foreach ($mutations as $mutation) {
            ...
            $pendapatan_mutasi = $mutation->pendapatan_mutasi == 'true' ? 1 : 0;
            ...
            // inserting data into the `mutations` table, change this to your table name
            ...
            foreach ($detail_mutasi as $detail) {
                ...
                // inserting data into the `detail_mutations` table, change this to your table name
                $this->db->insert('detail_mutations', $datas);
            }
